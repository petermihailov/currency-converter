  ...
  return (
    <div className={classes.app}>
      ...
      <div className={classes.displayWrapper}>
        <div
          className={`${classes.flagBg} ${classes.flagBgLeft}`}
          style={{ backgroundImage: `url(./flags/${state.leftCode.slice(0, 2)}.webp)` }}
        />
        <div
          className={`${classes.flagBg} ${classes.flagBgRight}`}
          style={{ backgroundImage: `url(./flags/${state.rightCode.slice(0, 2)}.webp)` }}
        />
